  ...
  return (
    <section className='custom-width h-screen mx-auto flex justify-between'>
      <div className='max-w-max cs-950:max-w-[400px] cs-780:max-w-[600px] flex flex-col justify-center gap-3'>
        ...
        <p className='max-w-[600px] cs-1000:max-w-[500px] cs-780:max-w-[600px] cs-659:max-w-[400px] cs-400:max-w-[290px] text-[18px] cs-950:text-[16px]'>Me gusta crear productos frontend sólidos y escalables con excelentes experiencias de usuario. <span className='font-bold'>Me gusta aprender tecnologías nuevas. 💻</span></p>
