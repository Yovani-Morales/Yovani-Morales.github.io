const Email = (props) => (
  ...
  >
    ...
    <path
      fill="#b7b6ad"
      d="m7.003 7.873 4.86 3.47V4.297c-.804.599-1.604 1.199-2.405 1.792-.758.561-1.517 1.116-2.282 1.657l-.173.126z"
    />
    <path fill="#b7b6ad" d="m2.15 11.434-.037-.05L7.01 7.827l.036.05z" />
    <path
      fill="#e75a4d"
